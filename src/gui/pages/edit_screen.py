...
class TopLabel(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.top_label = Label(text="Edit Task", font_size = (30))
        ...
        for i in text_field_headings:
            ...
            if i == "Description":
                text_input = TextInput(pos=(18, y_pos + 185), size=(220, 60),
                                       size_hint=(None, None), text=text_field_previous_data[i])
            else:
                text_input = TextInput(pos=(18, y_pos + 230), multiline=False, size=(220, 23), size_hint=(None, None),
                                       font_size=10, text=text_field_previous_data[i])
            y_pos -= 30
...
class MainApp(App):
    ...
    def build(self):
        ...
        top_label_widget = TopLabel(pos=(-118, 200))
